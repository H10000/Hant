    ...
    var init = function (obj) {
        table.render({
            ...
            , cols: [[ //表头
                ...
                , { field: 'RoleName', title: '组织名', align: 'center' }
                , {
        ...
        switch (obj.event) {
            case 'add':
                var data = {
                    title: '添加'
                    , type: 'add'
                    , list: [{ title: '流程名称', name: 'name', value: '', type: 'text' }, { title: '表单选择', name: 'tablename', value: '', type: 'radioSelect', data: selectdatas }
                        , { title: '页面地址', name: 'pageaddress', value: '', type: 'text' }]
                    , id: ''
                }
